...
public class InoxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i1 = (ImageView)findViewById(R.id.seata);
        i2 = (ImageView)findViewById(R.id.seatb);
        i3 = (ImageView)findViewById(R.id.seatc);
        i4 = (ImageView)findViewById(R.id.seatd);
        i5 = (ImageView)findViewById(R.id.seate);
        i6 = (ImageView)findViewById(R.id.seatf);
        i7 = (ImageView)findViewById(R.id.seatg);
        i8 = (ImageView)findViewById(R.id.seath);
        i9 = (ImageView)findViewById(R.id.seati);
        i10 = (ImageView)findViewById(R.id.seatj);
        ...
        userinox1 = FirebaseDatabase.getInstance().getReference(uid1 + "/Movie/Inox1");
        userwallet = FirebaseDatabase.getInstance().getReference(uid1 + "/Wallet");
        databaseReferencea = FirebaseDatabase.getInstance().getReference("Inox/Inox1/Gold/seatA");
        databaseReferenceb = FirebaseDatabase.getInstance().getReference("Inox/Inox1/Gold/seatB");
        databaseReferencec = FirebaseDatabase.getInstance().getReference("Inox/Inox1/Gold/seatC");
        databaseReferenced = FirebaseDatabase.getInstance().getReference("Inox/Inox1/Gold/seatD");
        databaseReferencee = FirebaseDatabase.getInstance().getReference("Inox/Inox1/Gold/seatE");
        databaseReferencef = FirebaseDatabase.getInstance().getReference("Inox/Inox1/Silver/seatF");
        databaseReferenceg = FirebaseDatabase.getInstance().getReference("Inox/Inox1/Silver/seatG");
        databaseReferenceh = FirebaseDatabase.getInstance().getReference("Inox/Inox1/Silver/seatH");
        databaseReferencei = FirebaseDatabase.getInstance().getReference("Inox/Inox1/Silver/seatI");
        databaseReferencej = FirebaseDatabase.getInstance().getReference("Inox/Inox1/Silver/seatJ");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(InoxActivity.this,CinemaActivity1.class));
            }
        });
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            startActivity(new Intent(InoxActivity.this,EventConfirm.class));
