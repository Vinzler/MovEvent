...
public class InoxActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inox2);
        ...
        i1 = (ImageView)findViewById(R.id.seata2);
        i2 = (ImageView)findViewById(R.id.seatb2);
        i3 = (ImageView)findViewById(R.id.seatc2);
        i4 = (ImageView)findViewById(R.id.seatd2);
        i5 = (ImageView)findViewById(R.id.seate2);
        i6 = (ImageView)findViewById(R.id.seatf2);
        i7 = (ImageView)findViewById(R.id.seatg2);
        i8 = (ImageView)findViewById(R.id.seath2);
        i9 = (ImageView)findViewById(R.id.seati2);
        i10 = (ImageView)findViewById(R.id.seatj2);
        ...
        userinox1 = FirebaseDatabase.getInstance().getReference(uid1 + "/Movie/Inox2");
        userwallet = FirebaseDatabase.getInstance().getReference(uid1 + "/Wallet");
        databaseReferencea = FirebaseDatabase.getInstance().getReference("Inox/Inox2/Gold/seatA");
        databaseReferenceb = FirebaseDatabase.getInstance().getReference("Inox/Inox2/Gold/seatB");
        databaseReferencec = FirebaseDatabase.getInstance().getReference("Inox/Inox2/Gold/seatC");
        databaseReferenced = FirebaseDatabase.getInstance().getReference("Inox/Inox2/Gold/seatD");
        databaseReferencee = FirebaseDatabase.getInstance().getReference("Inox/Inox2/Gold/seatE");
        databaseReferencef = FirebaseDatabase.getInstance().getReference("Inox/Inox2/Silver/seatF");
        databaseReferenceg = FirebaseDatabase.getInstance().getReference("Inox/Inox2/Silver/seatG");
        databaseReferenceh = FirebaseDatabase.getInstance().getReference("Inox/Inox2/Silver/seatH");
        databaseReferencei = FirebaseDatabase.getInstance().getReference("Inox/Inox2/Silver/seatI");
        databaseReferencej = FirebaseDatabase.getInstance().getReference("Inox/Inox2/Silver/seatJ");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(InoxActivity2.this,CinemaActivity2.class));
            }
        });
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(InoxActivity2.this,EventConfirm.class));
