...
public class InoxActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inox3);
        ...
        i1 = (ImageView)findViewById(R.id.seata3);
        i2 = (ImageView)findViewById(R.id.seatb3);
        i3 = (ImageView)findViewById(R.id.seatc3);
        i4 = (ImageView)findViewById(R.id.seatd3);
        i5 = (ImageView)findViewById(R.id.seate3);
        i6 = (ImageView)findViewById(R.id.seatf3);
        i7 = (ImageView)findViewById(R.id.seatg3);
        i8 = (ImageView)findViewById(R.id.seath3);
        i9 = (ImageView)findViewById(R.id.seati3);
        i10 = (ImageView)findViewById(R.id.seatj3);
        ...
        userinox1 = FirebaseDatabase.getInstance().getReference(uid1 + "/Movie/Inox3");
        userwallet = FirebaseDatabase.getInstance().getReference(uid1 + "/Wallet");
        databaseReferencea = FirebaseDatabase.getInstance().getReference("Inox/Inox3/Gold/seatA");
        databaseReferenceb = FirebaseDatabase.getInstance().getReference("Inox/Inox3/Gold/seatB");
        databaseReferencec = FirebaseDatabase.getInstance().getReference("Inox/Inox3/Gold/seatC");
        databaseReferenced = FirebaseDatabase.getInstance().getReference("Inox/Inox3/Gold/seatD");
        databaseReferencee = FirebaseDatabase.getInstance().getReference("Inox/Inox3/Gold/seatE");
        databaseReferencef = FirebaseDatabase.getInstance().getReference("Inox/Inox3/Silver/seatF");
        databaseReferenceg = FirebaseDatabase.getInstance().getReference("Inox/Inox3/Silver/seatG");
        databaseReferenceh = FirebaseDatabase.getInstance().getReference("Inox/Inox3/Silver/seatH");
        databaseReferencei = FirebaseDatabase.getInstance().getReference("Inox/Inox3/Silver/seatI");
        databaseReferencej = FirebaseDatabase.getInstance().getReference("Inox/Inox3/Silver/seatJ");
        ...
        userinox1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(info.equals("none"))
                {
                    x = info + "INOX: SCREEN3: A Beautiful Mind :";
                }
                else
                {
                    x = info + " ";
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(InoxActivity3.this,CinemaActivity3.class));
            }
        });
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(InoxActivity3.this,EventConfirm.class));
