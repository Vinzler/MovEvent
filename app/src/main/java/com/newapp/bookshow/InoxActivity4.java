...
public class InoxActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inox4);
        ...
        i1 = (ImageView)findViewById(R.id.seata4);
        i2 = (ImageView)findViewById(R.id.seatb4);
        i3 = (ImageView)findViewById(R.id.seatc4);
        i4 = (ImageView)findViewById(R.id.seatd4);
        i5 = (ImageView)findViewById(R.id.seate4);
        i6 = (ImageView)findViewById(R.id.seatf4);
        i7 = (ImageView)findViewById(R.id.seatg4);
        i8 = (ImageView)findViewById(R.id.seath4);
        i9 = (ImageView)findViewById(R.id.seati4);
        i10 = (ImageView)findViewById(R.id.seatj4);
        ...
        userinox1 = FirebaseDatabase.getInstance().getReference(uid1 + "/Movie/Inox4");
        userwallet = FirebaseDatabase.getInstance().getReference(uid1 + "/Wallet");
        databaseReferencea = FirebaseDatabase.getInstance().getReference("Inox/Inox4/Gold/seatA");
        databaseReferenceb = FirebaseDatabase.getInstance().getReference("Inox/Inox4/Gold/seatB");
        databaseReferencec = FirebaseDatabase.getInstance().getReference("Inox/Inox4/Gold/seatC");
        databaseReferenced = FirebaseDatabase.getInstance().getReference("Inox/Inox4/Gold/seatD");
        databaseReferencee = FirebaseDatabase.getInstance().getReference("Inox/Inox4/Gold/seatE");
        databaseReferencef = FirebaseDatabase.getInstance().getReference("Inox/Inox4/Silver/seatF");
        databaseReferenceg = FirebaseDatabase.getInstance().getReference("Inox/Inox4/Silver/seatG");
        databaseReferenceh = FirebaseDatabase.getInstance().getReference("Inox/Inox4/Silver/seatH");
        databaseReferencei = FirebaseDatabase.getInstance().getReference("Inox/Inox4/Silver/seatI");
        databaseReferencej = FirebaseDatabase.getInstance().getReference("Inox/Inox4/Silver/seatJ");

        back = (Button)findViewById(R.id.backbutton4);
        confirm = (Button)findViewById(R.id.confirmbutton4);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(InoxActivity4.this,CinemaActivity4.class));
            }
        });
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(InoxActivity4.this,EventConfirm.class));
