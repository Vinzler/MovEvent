...
public class PVRActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pvr2);
        ...
        i1 = (ImageView)findViewById(R.id.seata6);
        i2 = (ImageView)findViewById(R.id.seatb6);
        i3 = (ImageView)findViewById(R.id.seatc6);
        i4 = (ImageView)findViewById(R.id.seatd6);
        i5 = (ImageView)findViewById(R.id.seate6);
        i6 = (ImageView)findViewById(R.id.seatf6);
        i7 = (ImageView)findViewById(R.id.seatg6);
        i8 = (ImageView)findViewById(R.id.seath6);
        i9 = (ImageView)findViewById(R.id.seati6);
        i10 = (ImageView)findViewById(R.id.seatj6);
        ...
        userinox1 = FirebaseDatabase.getInstance().getReference(uid1 + "/Movie/PVR2");
        userwallet = FirebaseDatabase.getInstance().getReference(uid1 + "/Wallet");
        databaseReferencea = FirebaseDatabase.getInstance().getReference("PVR/PVR2/Gold/seatA");
        databaseReferenceb = FirebaseDatabase.getInstance().getReference("PVR/PVR2/Gold/seatB");
        databaseReferencec = FirebaseDatabase.getInstance().getReference("PVR/PVR2/Gold/seatC");
        databaseReferenced = FirebaseDatabase.getInstance().getReference("PVR/PVR2/Gold/seatD");
        databaseReferencee = FirebaseDatabase.getInstance().getReference("PVR/PVR2/Gold/seatE");
        databaseReferencef = FirebaseDatabase.getInstance().getReference("PVR/PVR2/Silver/seatF");
        databaseReferenceg = FirebaseDatabase.getInstance().getReference("PVR/PVR2/Silver/seatG");
        databaseReferenceh = FirebaseDatabase.getInstance().getReference("PVR/PVR2/Silver/seatH");
        databaseReferencei = FirebaseDatabase.getInstance().getReference("PVR/PVR2/Silver/seatI");
        databaseReferencej = FirebaseDatabase.getInstance().getReference("PVR/PVR2/Silver/seatJ");

        back = (Button)findViewById(R.id.backbutton6);
        confirm = (Button)findViewById(R.id.confirmbutton6);
        ...
        userinox1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(info.equals("none"))
                {
                    x = info + "PVR: SCREEN2: Imitation Game :";
                }
                else
                {
                    x = info + " ";
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PVRActivity2.this,CinemaActivity2.class));
            }
        });
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(PVRActivity2.this,EventConfirm.class));
            }
