...
public class PVRActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pvr4);
        ...
        i1 = (ImageView)findViewById(R.id.seata8);
        i2 = (ImageView)findViewById(R.id.seatb8);
        i3 = (ImageView)findViewById(R.id.seatc8);
        i4 = (ImageView)findViewById(R.id.seatd8);
        i5 = (ImageView)findViewById(R.id.seate8);
        i6 = (ImageView)findViewById(R.id.seatf8);
        i7 = (ImageView)findViewById(R.id.seatg8);
        i8 = (ImageView)findViewById(R.id.seath8);
        i9 = (ImageView)findViewById(R.id.seati8);
        i10 = (ImageView)findViewById(R.id.seatj8);
        ...
        userinox1 = FirebaseDatabase.getInstance().getReference(uid1 + "/Movie/PVR4");
        userwallet = FirebaseDatabase.getInstance().getReference(uid1 + "/Wallet");
        databaseReferencea = FirebaseDatabase.getInstance().getReference("PVR/PVR4/Gold/seatA");
        databaseReferenceb = FirebaseDatabase.getInstance().getReference("PVR/PVR4/Gold/seatB");
        databaseReferencec = FirebaseDatabase.getInstance().getReference("PVR/PVR4/Gold/seatC");
        databaseReferenced = FirebaseDatabase.getInstance().getReference("PVR/PVR4/Gold/seatD");
        databaseReferencee = FirebaseDatabase.getInstance().getReference("PVR/PVR4/Gold/seatE");
        databaseReferencef = FirebaseDatabase.getInstance().getReference("PVR/PVR4/Silver/seatF");
        databaseReferenceg = FirebaseDatabase.getInstance().getReference("PVR/PVR4/Silver/seatG");
        databaseReferenceh = FirebaseDatabase.getInstance().getReference("PVR/PVR4/Silver/seatH");
        databaseReferencei = FirebaseDatabase.getInstance().getReference("PVR/PVR4/Silver/seatI");
        databaseReferencej = FirebaseDatabase.getInstance().getReference("PVR/PVR4/Silver/seatJ");

        back = (Button)findViewById(R.id.backbutton8);
        confirm = (Button)findViewById(R.id.confirmbutton8);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PVRActivity4.this,CinemaActivity4.class));
            }
        });
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(PVRActivity4.this,EventConfirm.class));
            }
